...
public class Main {
    ...
    private static final String[] xSigPkHex = new String[4];

    private static final String[] teacherKey = {"2E76A0094D4CEE0AC516CA162973C895", ""};
    private static final String cTeacher = "E13AB087A49BBEC699AC5DEB165533D342CC552FD707EA483DDAA57404A7F7A984761C461F78FABDE29B91EFF5265B4D248837D9912CE1BF44DDC2263239A4B1DF3275DE1D73332202DA2234DC0782CE10D76A5E41F17DDFF9CAA385A358C48C";
    private static final String sig_cTeacher = "";

    // valores fixos para fins de ensino, não são gerados aleatoriamente (como no início do trabalho)
    private static final String s_valueFixed = "72862267910800375299092212796851321816";
    private static final String e_aFixed = "667b9292bac3c0da7840b1a533f026f1";
    private static final String d_aFixed = "";
    private static final String N_aFixed = "";
    ...
    public static void main(String[] args) throws NoSuchAlgorithmException, NoSuchPaddingException, InvalidAlgorithmParameterException, InvalidKeyException, IllegalBlockSizeException, BadPaddingException, UnsupportedEncodingException {
        ...
        // inicialmente gerei um valor aleatório e enviei para o professor, agora defino um N_a fixo
        N_a = new BigInteger(N_aFixed, 16);

        // calcula L = (p-1).(q-1)
        L_euler = calcEulerFunction(p_prime, q_prime);

        // encontra um e_a que seja primo relativo de L_euler
        // e_a = findRelativePrime();
        // inicialmente gerei um valor aleatório e enviei para o professor, agora defino um e_a fixo
        e_a = new BigInteger(e_aFixed, 16);

        // calcula o inverso d_a de e_a em Z_L
        // d_a = e_a.modInverse(L_euler);
        // inicialmente gerei um valor aleatório e enviei para o professor, agora defino um d_a fixo
        d_a = new BigInteger(d_aFixed, 16);
    ...
    private static BigInteger findRelativePrime() {
        BigInteger ea;
        SecureRandom random = new SecureRandom();
        do {
            ea = new BigInteger(128, random);
        } while (ea.compareTo(BigInteger.ONE) <= 0 || ea.compareTo(L_euler) >= 0 || !ea.gcd(L_euler).equals(BigInteger.ONE));
        return ea;
    }
